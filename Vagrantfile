...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "file", source: "vagrant/bootstrap/vagrant-blis-httpd-2.2.conf", destination: "/home/vagrant/vagrant-blis-httpd.conf"
  config.vm.provision "file", source: "vagrant/bootstrap/xdebug-precise.ini", destination: "/home/vagrant/xdebug.ini"
  ...
  config.vm.provision :shell, :inline => "sudo mv /home/vagrant/xdebug.ini /etc/php5/conf.d/xdebug.ini", run: "once"
  ...
  config.vm.provision :shell, :inline => "sudo rm -f /etc/apache2/sites-enabled/000-default", run: "once"
